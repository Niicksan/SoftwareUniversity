...
namespace Panda.Services
{
    public class PackagesService : IPackagesService
    {
        ...
        public IQueryable<Package> GetAllByStatus(PackageStatus status /*string username*/)
        {
            var package = this.db.Packages.Where(x => x.Status == status /*&& x.Recipient.Username == username*/);
            return package;
        }
    }
}
