...
namespace BillsPaymentSystem.Data.Migrations
{
    ...
    [Migration("20190317220745_BillsPaymentSystem")]
            ...
            modelBuilder.Entity("BillsPaymentSystem.Models.PaymentMethod", b =>
                {
                    ...
                    b.HasIndex("CreditCardtId")
                        .IsUnique()
                        .HasFilter("[CreditCardtId] IS NOT NULL");

                    b.HasIndex("UserId", "CreditCardtId", "BankAccountId")
                        .IsUnique()
                        .HasFilter("[CreditCardtId] IS NOT NULL AND [BankAccountId] IS NOT NULL");
            ...
            modelBuilder.Entity("BillsPaymentSystem.Models.PaymentMethod", b =>
                {
                    ...
                    b.HasOne("BillsPaymentSystem.Models.CreditCard", "CreditCard")
                        .WithOne("PaymentMethod")
                        .HasForeignKey("BillsPaymentSystem.Models.PaymentMethod", "CreditCardtId");
