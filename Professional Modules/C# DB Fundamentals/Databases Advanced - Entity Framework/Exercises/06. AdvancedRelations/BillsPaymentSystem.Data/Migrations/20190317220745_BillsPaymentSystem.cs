        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditCardtId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentMethods_CreditCards_CreditCardtId",
                        column: x => x.CreditCardtId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_CreditCardtId",
                table: "PaymentMethods",
                column: "CreditCardtId",
                unique: true,
                filter: "[CreditCardtId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_UserId_CreditCardtId_BankAccountId",
                table: "PaymentMethods",
                columns: new[] { "UserId", "CreditCardtId", "BankAccountId" },
                unique: true,
                filter: "[CreditCardtId] IS NOT NULL AND [BankAccountId] IS NOT NULL");
        }
