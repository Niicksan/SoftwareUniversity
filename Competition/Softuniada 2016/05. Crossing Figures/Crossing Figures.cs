...
namespace _05.Crossing_Figures
{
    class Program
    {
    ...
    public class Circle
    {
        ...
        {
            return (point.X - this.Center.X) * (point.X - this.Center.X) + (point.Y - this.Center.Y) * (point.Y - this.Center.Y) - this.Radius * this.Radius <= Program.Epsilon;
        }
    }
...
rectangle(-3, 5, 12, -2)
rectangle(-3, 5, 12, -2)
circle(4.96, 2.09, 2.01)
rectangle(-3, 5, 12, -2)
circle(11.29, 2.41, 2.15)
circle(6, -4, 2)
rectangle(-3, 5, 12, -2)
rectangle(-3, 5, 12, -2)
circle(13, -3, 1.41421)
circle(15.78, -5.18, 0.87)
rectangle(-3, 5, 12, -2)
